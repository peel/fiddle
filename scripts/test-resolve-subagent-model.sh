...
DEFAULT_CONFIG="$SCRIPT_DIR/../orchestrate.json"
...
assert_file_contains "README documents model values" 'Supported values are `default`, `smol`, and `slow`' "$README_DOC"
assert_file_contains "README documents role precedence" 'A role setting overrides its phase setting' "$README_DOC"
assert_file_contains "default config has phase models" '"discover": "default"' "$DEFAULT_CONFIG"
assert_file_contains "default config has role models" '"implementer": "default"' "$DEFAULT_CONFIG"
