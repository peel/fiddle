...
//! holds [`cli`], the single credential-carrying `gh` construction, and
//! [`refs`], the branch operation built on top of it; the pull-request and check
//! operations land beside them and all of them go through that one construction
