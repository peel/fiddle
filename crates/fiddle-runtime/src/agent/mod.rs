...
change part of a file, replace a file's contents, and run the project's check. \
You cannot do anything else, and there is nothing outside the project you can \
reach.\n\
\n\
