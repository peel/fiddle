...
pub use report::{
    AttemptOutcome, CapabilityExecution, DeferredFinding, DisposedFinding, EvidenceRef,
    FiddleBuild, ProgressEntry, ReportBundle, RunDisposition, CONFIG_CHECK_SCHEMA, INSPECT_SCHEMA,
    REPORT_SCHEMA, RUN_SCHEMA, UNKNOWN_REVISION,
};
